  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
      <motion.div
        ...
        className="bg-white dark:bg-[#072418] border border-stone-200 dark:border-ceylon-gold/30 rounded-2xl sm:rounded-3xl max-w-lg w-full overflow-hidden shadow-2xl relative text-left my-auto"
      >
        {/* Header */}
